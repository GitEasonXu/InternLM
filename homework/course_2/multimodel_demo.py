...
add_path = 'InternLM-XComposer'
# 判断目标目录是否存在并且不在已有的搜索路径中
if add_path not in sys.path and os.path.exists(add_path):
...
parser.add_argument("--folder", default='/root/model/Shanghai_AI_Laboratory/internlm-xcomposer-7b')
